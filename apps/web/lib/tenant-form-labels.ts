...
export function tenantFormLabels(t: Translate, submit: string, done: string): TenantFormLabels {
  return {
    ...
    allowedEmailDomains: t('platform.admin.field.allowedEmailDomains'),
    joinMode: t('platform.admin.field.joinMode'),
    joinModeDomain: t('platform.admin.field.joinMode.domain'),
    joinModeInvite: t('platform.admin.field.joinMode.invite'),
