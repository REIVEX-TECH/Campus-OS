...
/**
 * The verification queue: who is asking to be verified, and a way to verify
 * someone by hand.
 *
 * Gated by `approve-verifications`, resolved on this request; anyone without
 * it gets a 404, so the page's existence says nothing about who holds it.
 * Every action below is re-checked on the server inside its own transaction.
 * Handles only: no email is read anywhere on this page.
 */
  ...
  return (
    <PageShell>
      <div className="flex flex-col gap-5">
        ...
        <AdminNav base={base} permissions={permissions} current="verification" t={t} />
