...
| #29 platform SEO                     | pending   | Give the platform landing (`/`) the metadata it lacked: canonical, OpenGraph, and a Twitter card, plus a `WebSite` JSON-LD node. Every public page now has full social/canonical metadata. e2e.                                                                                                                                                                                                                                 |
