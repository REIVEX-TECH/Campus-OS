...
| #32 skip to content                  | pending   | Accessibility: a "Skip to content" link (first tab stop, visually hidden until focused) on the tenant app shell and platform landing, jumping keyboard and screen-reader users past the header nav to the `#main` landmark. i18n. Keyboard-focus e2e.                                                                                                                                                                           |
